...
public class iceVehiclePopulator implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                IceVehicle userVehicle = new IceVehicle(24, 350, 24000, 1800, 7f, 120, twoTwelve, ford, f150,
                                "https://images.hgmsites.net/hug/2012-ford-f-150-2wd-supercab-163-xl-side-exterior-view_100373810_h.jpg");
                iceVehicleStorage.saveIceVehicle(userVehicle);

                IceVehicle fordMustang2012 = new IceVehicle(25, 325, 16000, 1500, 6.5f, 160, twoTwelve, ford, mustang,
                                "https://s.aolcdn.com/commerce/autodata/images/CAC20FOC051B0101.jpg");
                iceVehicleStorage.saveIceVehicle(fordMustang2012);

                IceVehicle fordExplorer2012 = new IceVehicle(24, 275, 12000, 1500, 8.5f, 140, twoTwelve, ford, explorer,
                                "https://file.kelleybluebookimages.com/kbb/base/evox/CP/7597/2012-Ford-Explorer-front_7597_032_1812x872_HT_cropped.png");
                iceVehicleStorage.saveIceVehicle(fordExplorer2012);

                IceVehicle fordFiesta2012 = new IceVehicle(35, 375, 7000, 1200, 8f, 140, twoTwelve, ford, fiesta,
                                "https://file.kelleybluebookimages.com/kbb/base/evox/CP/7657/2012-Ford-Fiesta-front_7657_032_1753x812_SQ_cropped.png");
                iceVehicleStorage.saveIceVehicle(fordFiesta2012);

                IceVehicle fordTaurus2012 = new IceVehicle(30, 375, 12000, 1250, 7f, 135, twoTwelve, ford, taurus,
                                "https://file.kelleybluebookimages.com/kbb/base/evox/CP/7677/2012-Ford-Taurus-front_7677_032_1785x739_HT_cropped.png");
                iceVehicleStorage.saveIceVehicle(fordTaurus2012);

                IceVehicle fordFusion2018 = new IceVehicle(28, 375, 20000, 1250, 6.5f, 150, twoEighteen, ford2018,
                                fusion,
                                "https://file.kelleybluebookimages.com/kbb/base/evox/CP/12239/2018-Ford-Fusion-front_12239_032_1795x753_G1_cropped.png");
                iceVehicleStorage.saveIceVehicle(fordFusion2018);

                IceVehicle fordFocus2018 = new IceVehicle(31, 375, 25000, 1250, 7.5f, 120, twoEighteen, ford2018, focus,
                                "https://file.kelleybluebookimages.com/kbb/base/evox/CP/12239/2018-Ford-Fusion-front_12239_032_1795x753_G1_cropped.png");
                iceVehicleStorage.saveIceVehicle(fordFocus2018);

                IceVehicle acuraMdx4wd2016 = new IceVehicle(21, 410, 52875, 1800, 6.4f, 140, twoSixteen, acura2016,
                                mdx4wd,
                ...
                IceVehicle audiA62018 = new IceVehicle(28, 554, 51900, 1800, 6.7f, 155, twoEighteen, audi2018, a6,
                                "https://s.aolcdn.com/commerce/autodata/images/USC60AUC021B021001.jpg");
                iceVehicleStorage.saveIceVehicle(audiA62018);

                IceVehicle bmw530i2017 = new IceVehicle(27, 486, 51200, 1800, 6.2f, 130, twoSeventeen, bmw2017, five30i,
                ...
                IceVehicle cadillacCts2015 = new IceVehicle(21, 389, 55345, 1800, 5.5f, 155, twoFifteen, cadillac2015,
                                ctsSedanAwd, "https://s.aolcdn.com/commerce/autodata/images/USC50CAC112F021001.jpg");
                iceVehicleStorage.saveIceVehicle(cadillacCts2015);

                IceVehicle camaro2014 = new IceVehicle(21, 399, 24450, 1800, 5.8f, 155, twoFourteen, chevrolet2014,
                                camaro,
                ...
                IceVehicle challenger2013 = new IceVehicle(21, 401, 29995, 1800, 5.4f, 182, twoThirteen, dodge2013,
                                challenger,
                ...
                IceVehicle escape2018 = new IceVehicle(24, 377, 30050, 1800, 7.2f, 141, twoEighteen, ford2018, escape,
                ...
                IceVehicle g80Awd2017 = new IceVehicle(19, 386, 43900, 1800, 5.2f, 154, twoSeventeen, genesis2017,
                                g80Awd, "https://pictures.topspeed.com/IMG/jpg/201611/genesis-beefs-up-lin-5.jpg");
                iceVehicleStorage.saveIceVehicle(g80Awd2017);

                IceVehicle terrainAwd2018 = new IceVehicle(32, 499, 35570, 1800, 6.8f, 140, twoEighteen, gmc2018,
                                terrainAwd,
                ...
                IceVehicle konaAwd2019 = new IceVehicle(27, 356, 26390, 1800, 6.6f, 127, twoNineteen, hyundai2019,
                                konaAwd,
                ...
                IceVehicle fTypeCoupe2016 = new IceVehicle(22, 407, 65000, 1800, 5.1f, 161, twoSixteen, jaguar2016,
                                fTypeCoupe,
                ...
                IceVehicle wrangler4Wd2015 = new IceVehicle(18, 335, 31995, 1800, 6.1f, 103, twoFifteen, jeep2015,
                                wrangler4Wd, "https://images.hgmsites.net/hug/2015-jeep-wrangler_100479434_h.jpg");
                iceVehicleStorage.saveIceVehicle(wrangler4Wd2015);

                IceVehicle niro2019 = new IceVehicle(49, 583, 25900, 1800, 9.4f, 100, twoNineteen, kia2019, niro,
                ...
                IceVehicle rx350Awd2014 = new IceVehicle(20, 384, 44160, 1800, 7.7f, 124, twoFourteen, lexus2014,
                                rx350Awd, "https://s.aolcdn.com/commerce/autodata/images/USC40LES122A021001.jpg");
                iceVehicleStorage.saveIceVehicle(rx350Awd2014);

                IceVehicle mksAwd2016 = new IceVehicle(19, 361, 43605, 1800, 6.4f, 161, twoSixteen, lincoln2016, mksAwd,
                                "https://s.aolcdn.com/commerce/autodata/images/USC30LIC091A021001.jpg");
                iceVehicleStorage.saveIceVehicle(mksAwd2016);

                IceVehicle cx54Wd2017 = new IceVehicle(26, 398, 27845, 1800, 6.1f, 125, twoSeventeen, mazda2017, cx54Wd,
                ...
                IceVehicle cls5502013 = new IceVehicle(20, 422, 72000, 1800, 5.5f, 168, twoThirteen, mercedes2013,
                                cls550,
